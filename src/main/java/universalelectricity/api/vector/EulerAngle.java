 ...
 * 
 * Note: The rotational system Minecraft uses is non-standard. The angles and
 * vector calculations have been calibrated to match. DEFINITIONS:
 * 
 * Yaw: 0 Degrees - Looking at NORTH 90 - Looking at WEST 180 - Looking at SOUTH
 * 270 - Looking at EAST
 * 
 * Pitch: 0 Degrees - Looking straight forward towards the horizon. 90 Degrees -
 * Looking straight up to the sky. -90 Degrees - Looking straight down to the
 * void.
 * 
 * Make sure all models are use the Techne Model loader, they will naturally
 * follow this rule.
 * 
 * @author Calclavia
 */
