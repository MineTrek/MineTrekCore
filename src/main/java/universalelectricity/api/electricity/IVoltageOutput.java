...
/**
 * Applied to electrical machines that are designed to act as sources of power
 * in an electrical network. Mainly used to calculate the over all voltage of a
 * network correctly.
 * 
...
public interface IVoltageOutput {
	 ...
	 * 
	 * @param side
	 *            - side that the voltage will be emitted on
