...
public interface IEnergyInterface extends IConnectable {
	 ...
	 * This should always return 0 if the block cannot be externally charged.
	 * 
	 * @param from
	 *            Orientation the energy is sent in from.
	 * @param receive
	 *            Maximum amount of energy (joules) to be sent into the block.
	 * @param doReceive
	 ...
	 * extracted. This should always return 0 if the block cannot be externally
	 * discharged.
	 * 
	 * @param from
	 *            Orientation the energy is requested from. This direction MAY
	 *            be passed as "Unknown" if it is wrapped from another energy
	 *            system that has no clear way to find direction. (e.g
	 *            BuildCraft 4)
	 * @param energy
